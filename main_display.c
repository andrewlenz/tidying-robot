...
static simple_ble_char_t display_state_char = {.uuid16 = 0x9999};
static char display_state[12] = "test\0";
/*******************************************************************************
...
void ble_evt_write(ble_evt_t const* p_ble_evt) {
    ...
    if (simple_ble_is_char_event(p_ble_evt, &display_state_char)) {
      printf("Got write to Display!\n");
      display_write("            \0", DISPLAY_LINE_0);
      display_write(display_state, DISPLAY_LINE_0);
    }
    if (simple_ble_is_char_event(p_ble_evt, &display_service)) {
      printf("Got write to Display!\n");
      display_write("            \0", DISPLAY_LINE_0);
      display_write(display_state, DISPLAY_LINE_0);
    }
...
int main(void) {
  ...
  simple_ble_add_characteristic(1, 1, 0, 0,
      sizeof(char) * 12, (char*)&display_state,
      &display_service, &display_state_char);
